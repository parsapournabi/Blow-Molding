...
class QItemBase : public QObject
{
    ...
    public:
        ...
        QItemBase(QObject* parent = nullptr)
        // :
        // QObject{parent}
        {
            setEmpty(true);
        ...
        QVariant getBaseItemValueByRole(int role) const
        {
            ...
            switch (role)
            {
                case static_cast<int>(BaseItemRoles::IdRole):
                    return id();
                case static_cast<int>(BaseItemRoles::RowRole):
                    return row();
                case static_cast<int>(BaseItemRoles::ItemSelectedRole):
                    return itemSelected();
                default:
                    return {};
            }
        ...
        QVariantMap getBaseItemHeaderDataByRole(int role) const
        {
            ...
            {
                case static_cast<int>(BaseItemRoles::IdRole):
                    return QVariantMap({{"title", "ID"}, {"columnWidth", 100}, {"visible", true}, {"kill", true}});
                case static_cast<int>(BaseItemRoles::RowRole):
                    return QVariantMap({{"title", "ROW"}, {"columnWidth", 100}, {"visible", true}, {"kill", true}});
                case static_cast<int>(BaseItemRoles::ItemSelectedRole):
                    return QVariantMap({{"title", "SELECTED"}, {"columnWidth", 100}, {"visible", true}, {"kill", true}});
                default:
                    return QVariantMap();
            }
